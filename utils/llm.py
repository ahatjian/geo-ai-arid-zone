...
MODULE_DEFINITIONS = [
    ...
    {"name": "数据下载中心", "page": "20_数据下载中心", "icon": "📦",
     "keywords": ["下载中心", "下载", "结果管理", "持久化", "打包", "结果库", "保存结果", "批量下载"],
     "desc": "结果持久化 + 统一下载/打包/删除"},
    {"name": "系统状态", "page": "21_系统状态", "icon": "🛠️",
     "keywords": ["缓存", "清理", "系统", "状态", "健康", "环境", "内存"],
     "desc": "缓存管理 + 环境健康检查"},
    {"name": "图像增强", "page": "22_图像增强", "icon": "🎨",
     "keywords": ["图像增强", "主成分", "pca", "滤波", "锐化", "直方图", "融合", "对比度", "图像处理"],
     "desc": "PCA/空间滤波/对比度增强/IHS融合"},
    {"name": "大气校正", "page": "23_辐射定标大气校正", "icon": "🌤️",
     "keywords": ["大气校正", "辐射定标", "dos", "暗像元", "反射率", "预处理", "大气", "定标"],
     "desc": "DOS暗像元法大气校正 + 辐射定标 + 相对归一化"},
    {"name": "空间邻域分析", "page": "24_空间邻域分析", "icon": "🗺️",
     "keywords": ["缓冲区", "邻域", "叠加", "空间分析", "缓冲", "空间关系", "交叉表", "梯度"],
     "desc": "AI智能缓冲区 + 邻域统计 + 叠加交叉分析"},
    {"name": "AI智能助手", "page": "25_AI助手", "icon": "🤖",
     "keywords": ["ai助手", "对话", "问答", "一键分析", "自动分析", "异常检测", "chat", "assistant", "自动"],
     "desc": "AI对话 + 一键自动分析 + 异常检测"},
]
